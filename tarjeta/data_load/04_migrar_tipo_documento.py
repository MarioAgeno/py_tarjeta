# Migrar tabla tipo_documento de Tarjetas al modelos DJango
...
cursor.execute("SELECT * FROM tipodoc")
...
# Transacción para insertar los datos de Tipos de Documentos en Django
with transaction.atomic():
    ...
    for row in cursor.fetchall():
        ...
        TipoDocumentoIdentidad.objects.create(
            ...
            tipo_documento_identidad=row[0],
