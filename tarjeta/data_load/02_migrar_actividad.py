# Migrar tabla Actividad de Tarjetas al modelos DJango
...
cursor.execute("SELECT * FROM tjActividades")
...
with transaction.atomic():
    ...
    for row in cursor.fetchall():
        ...
        Actividad.objects.create(
            ...
            interes_actividad=row[2],
            codigo_afip=row[3] if row[3] is not None else 0
        )
