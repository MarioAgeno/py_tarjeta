# Migrar tabla Titulo de Tarjetas al modelos DJango
...
from apps.maestros.models.base_models import Titulo
...
cursor.execute("SELECT * FROM tjTitulos")
...
with transaction.atomic():
    ...
    reset_titulo()  # Eliminar datos existentes antes de migrar
    ...
    for row in cursor.fetchall():
        ...
        Titulo.objects.create(
            estatus_titulo=True, 
            titulo=row[1]     # Asegúrate de que 'nombre' es el nombre correcto de la columna en SQL Server
        )
