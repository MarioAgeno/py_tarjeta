# Migrar tabla tarjeta_estado de Tarjetas al modelos DJango
...
from apps.maestros.models.base_models import TarjetaEstado
...
cursor.execute("SELECT * FROM tjEstados")
...
# Transacción para insertar los datos de Estdos de Tarjeta en Django
with transaction.atomic():
    ...
    for row in cursor.fetchall():
        ...
        TarjetaEstado.objects.create(
            estatus_tarjeta_estado=True,
            descripcion_tarjeta_estado=row[1],
            mensaje=row[2]
        )
