...
class LiquidacionSocio(ModeloBaseGenerico):
    ...
    cierre_anterior = models.DateTimeField("Cierre Anterior", blank=True)
    cierre_actual = models.DateTimeField("Cierre Actual", blank=True)
    cierre_proximo = models.DateTimeField("Proximo Cierre", blank=True)
    vencimiento_anterior = models.DateTimeField("Vencimiento Anterior", blank=True)
    vencimiento = models.DateTimeField("Vencimiento", blank=True)
    vencimiento_proximo = models.DateTimeField("Proximo Vencimiento", blank=True)
    ...
    importe_liquidacion = models.DecimalField("Importe", db_column="importe", 
...
class Cuota(ModeloBaseGenerico):
    ...
    vencimiento_cuota = models.DateTimeField("Vencimiento", db_column="vencimiento")
