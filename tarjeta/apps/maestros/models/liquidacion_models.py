...
class LiquidacionSocio(ModeloBaseGenerico):
    ...
    limite_tarjeta = models.DecimalField("Limite Tarjeta", max_digits=14, decimal_places=2, blank=True)
    saldo_anterior = models.DecimalField("Saldo Anterior", max_digits=14, decimal_places=2, blank=True)
    pago_anterior = models.DecimalField("Pago Anterior", max_digits=14, decimal_places=2, blank=True)
    importe_liquidacion = models.DecimalField("Importe", db_column="importe", max_digits=14, decimal_places=2, blank=True)
    pago_minimo = models.DecimalField("Pago Minimo", db_column="minimo", max_digits=14, decimal_places=2, blank=True)
    importe_seguro = models.DecimalField("Seguro", db_column="seguro", max_digits=14, decimal_places=2, blank=True)
    importe_gasto = models.DecimalField("Gastos", db_column="gastos", max_digits=14, decimal_places=2, blank=True)
    importe_interes = models.DecimalField("Interes", db_column="interes", max_digits=14, decimal_places=2, blank=True)
    importe_punitorio = models.DecimalField("Punitorios", db_column="punitorio", max_digits=14, decimal_places=2, blank=True)
...
class Cuota(ModeloBaseGenerico):
    ...
    capital_cuota = models.DecimalField("Capital", db_column="capital", max_digits=14, decimal_places=2)
    interes_cuota = models.DecimalField("Interes", db_column="interes", max_digits=14, decimal_places=2)
    importe_cuota = models.DecimalField("Importe Cuota", db_column="importe", max_digits=14, decimal_places=2)
    liquidacion_socio = models.IntegerField("Numero Liquidacion", db_column="liquidacion", blank=True)
