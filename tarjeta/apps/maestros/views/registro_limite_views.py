# tarjeta\apps\maestros\views\registro_limite_views.py
from django.urls import reverse_lazy
from ..views.cruds_views_generics import *
from ..models.tarjeta_models import RegitroLimite
from ..forms.registro_limite_forms import RegitroLimiteForm
...
# RegitroLimiteList - Inicio
class RegitroLimiteListView(MaestroListView):
...
# RegitroLimiteCreateView - Inicio
class RegitroLimiteCreateView(MaestroCreateView):
	model = ConfigViews.model
	list_view_name = ConfigViews.list_view_name
...
# class RegitroLimiteUpdateView
class RegitroLimiteUpdateView(MaestroUpdateView):
	model = ConfigViews.model
	list_view_name = ConfigViews.list_view_name
	form_class = ConfigViews.form_class
	template_name = ConfigViews.template_form
...
# class RegitroLimiteDeleteView
class RegitroLimiteDeleteView (MaestroDeleteView):
	model = ConfigViews.model
	list_view_name = ConfigViews.list_view_name
