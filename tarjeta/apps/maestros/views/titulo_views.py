# tarjeta\apps\maestros\views\titulo_views.py
from django.urls import reverse_lazy
from ..views.cruds_views_generics import *
from ..models.base_models import Titulo
from ..forms.titulo_forms import TituloForm
...
class DataViewList():
	...
	table_headers = {
		'estatus_titulo': (1, 'Estado'),
		'titulo': (4, 'Descripción'),
		'acciones': (2, 'Acciones'),
	}
	
	table_data = [
		{'field_name': 'estatus_titulo', 'date_format': None},
		{'field_name': 'titulo', 'date_format': None},
	]


# TituloListView - Inicio
class TituloListView(MaestroListView):
...
# TituloCreateView - Inicio
class TituloCreateView(MaestroCreateView):
	model = ConfigViews.model
	list_view_name = ConfigViews.list_view_name
...
# TituloUpdateView
class TituloUpdateView(MaestroUpdateView):
	model = ConfigViews.model
	list_view_name = ConfigViews.list_view_name
	form_class = ConfigViews.form_class
	template_name = ConfigViews.template_form
...
# TituloDeleteView
class TituloDeleteView (MaestroDeleteView):
	model = ConfigViews.model
	list_view_name = ConfigViews.list_view_name
