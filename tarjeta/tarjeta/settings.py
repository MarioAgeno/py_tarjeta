"""
Django settings for tarjeta project.
...
# SECRET_KEY = 'django-insecure-pga3_98+(r7g-2yg+pmx&+()0i)wmm@mzpohqvtmi8sw_yo@tx'
...
WSGI_APPLICATION = 'tarjeta.wsgi.application'
...
DATABASES = {
    'default': {
		...
		'NAME': path.join(BASE_DIR, 'data', 'db_tarjeta.db'),
    }
}
